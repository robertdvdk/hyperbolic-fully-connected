...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        wandb.log(
            {
                ...
                "test/top1_accuracy": test_metrics["top1_accuracy"],
                "test/top5_accuracy": test_metrics["top5_accuracy"],
        ...
        print(
            f"Epoch {epoch + 1:02d} | Train Loss: {train_loss:.4f} | Val Acc: {val_metrics['top1_accuracy']:.2f}% | Test Acc: {test_metrics['top1_accuracy']:.2f}%"
        )
